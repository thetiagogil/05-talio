    ...
    >
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/personal" element={<Navigate replace to="/personal/profile" />} />
          <Route path="/personal/:tab" element={<PersonalPage />} />
          <Route path="/team" element={<Navigate replace to="/team/overview" />} />
          <Route path="/team/:tab" element={<TeamPage />} />
          <Route path="/learn" element={<LearnPage />} />
          <Route path="/activity" element={<Navigate replace to="/activity/all" />} />
